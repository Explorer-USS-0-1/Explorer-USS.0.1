...
The decision to use the ESP-NOW protocol is due to the reliability, low energy consumption, high message transfer speed and long connection distance it can maintain.
