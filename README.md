...
>[!Note]
>
> Is possible to test every part of the project separatley, just go in the Tools folder, or in the separate testing tools one, and try whatever you want (for the rover parts, you will need to implememt an external joystick for testing, but not the full one).
